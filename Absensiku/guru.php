        ...
        <div class="card-body">
            <div class="row">
                <div class="col d-flex justify-content-end">
                    <button class="btn btn-success mb-2" data-bs-toggle="modal" data-bs-target="#ModalTambahUser"> Tambah Data Guru</button>
                </div>
            </div>
            <!-- Modal Tambah Baru-->
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/proses_input_guru.php" method="POST">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-success" name="input_guru_validate" value="1234">Save</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            ?>
                <!-- Modal View-->
                <div class="modal fade" id="ModalView<?php echo $row['idg'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-xl modal-fullscreen-md-down">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_input_guru.php" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-floating mb-3">
                                                <select disabled class="form-select" aria-label="Default select example" required name="jk" idg="">
                                                    <?php
                ...
                <!-- Modal Edit-->
                <div class="modal fade" id="ModalEdit<?php echo $row['idg'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-xl modal-fullscreen-md-down">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_edit_Guru.php" method="POST">
                                    <input type="hidden" value="<?php echo $row['idg'] ?>" name="idg">
                                    <div class="row">
                                    <div class="col-lg-6">
                                            <div class="form-floating mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-floating mb-3">
                                                <select class="form-select" aria-label="Default select example" required name="jk" idg="">
                                                    <?php
                                                    $data = array("laki-laki", "Perempuan");
                                                    foreach ($data as $key => $value) {
                                                        if ($row['jk'] == $key + 1) {
                                    ...
                                    <div class="form-floating">
                                        <textarea class="form-control" idg="" style="height:100px" name="alamat"><?php echo $row['alamat'] ?></textarea>
                                        <label for="floatingInput">Alamat</label>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                        <button type="submit" class="btn btn-warning" name="input_guru_validate" value="1234">Save</button>
                                        </class=>
                                    </div>
                                </form>
                            </div>
                ...
                <!-- Modal Delete-->
                <div class="modal fade" id="ModalDelete<?php echo $row['idg'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_delete_guru.php" method="POST">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                        <button type="submit" class="btn btn-danger" name="input_guru_validate" value="1234">Hapus</button>
                                        </class=>
                                    </div>
                                </form>
                            </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        <button class="btn btn-info btn-sm me-1" data-bs-toggle="modal" data-bs-target="#ModalView<?php echo $row['idg'] ?>"><i class="bi bi-eye"></i></button>
                                        <button class="btn btn-warning btn-sm me-1" data-bs-toggle="modal" data-bs-target="#ModalEdit<?php echo $row['idg'] ?>"><i class="bi bi-pencil-square"></i></button>
                                        <button class="btn btn-danger btn-sm me-1 " data-bs-toggle="modal" data-bs-target="#ModalDelete<?php echo $row['idg'] ?>"><i class="bi bi-trash"></i></button>
                                    </td>
                                </tr>
                            <?php
                            }
