                        ...
                        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel" style="width: 200px;">
                            ...
                            <div class="offcanvas-body">
                                <ul class="navbar-nav nav-pills flex-column justify-content-end flex-grow-1">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link ps-2 <?php echo (isset($_GET['x']) && $_GET['x']=='absensiku') ? 'active link-light' : 'link-dark' ; ?>" href="absensiku"><i class="bi bi-calendar2-check"></i> Absensiku</a>
                                    </li>
                                    <?php } ?>

                                    <?php if($hasil['level']==2){?>
                                    <li class="nav-item">
                                        <a class="nav-link ps-2 <?php echo (isset($_GET['x']) && $_GET['x']=='jadwalguru') ? 'active link-light' : 'link-dark' ; ?>" href="jadwalguru"><i class="bi bi-ui-checks"></i> Jadwal Saya</a>
                                    </li>
                                    <?php } ?>
                                </ul>
                            </div>
