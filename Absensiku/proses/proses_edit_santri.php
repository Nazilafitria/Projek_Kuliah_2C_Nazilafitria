...
if (!empty($_POST['input_santri_validate'])) {
    ...
    if (mysqli_num_rows($select) > 0) {
        ...
        $query = mysqli_query($conn, "UPDATE tb_santri SET nik='$nik', nama='$name', jk='$jk', kelas='$kelas', nohp='$nohp' , alamat='$alamat' , namaayah='$namaayah' , kerjaayah='$kerjaayah' , namaibu='$namaibu' , kerjaibu='$kerjaibu' WHERE ids='$ids' ");
        if ($query) {
