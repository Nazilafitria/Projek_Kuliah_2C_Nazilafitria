...
$jumblah = (isset($_POST['jumblah'])) ? htmlentities($_POST['jumblah']) : "";
...
if (!empty($_POST['input_orderitem_validate'])) {
    ...
    if (mysqli_num_rows($select) > 0) {
        ...
        $query = mysqli_query($conn, "INSERT INTO tb_list_order (menu,kode_order,jumblah,catatan) values ('$menu','$kode_order','$jumblah','$catatan')");
        if ($query) {
