...
$query = mysqli_query($conn, "SELECT *, SUM(harga*jumblah) AS harganya FROM tb_list_order
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/proses_input_orderitem.php" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-floating mb-3">
                                            <input type="number" class="form-control" id="floatingInput" placeholder="ajumblah Porsi" name="jumblah" required>
                                            <label for="floatingInput">Jumblah Porsi</label>
                                            <div class="invalid-feedback">
                                                Masukkan Jumblah Porsi
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal-body">
                                    <form class="needs-validation" novalidate action="proses/proses_edit_orderitem.php" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-floating mb-3">
                                                    <input type="number" class="form-control" id="floatingInput" placeholder="ajumblah Porsi" name="jumblah" required value="<?php echo $row['jumblah'] ?>">
                                                    <label for="floatingInput">Jumblah Porsi</label>
                                                    <div class="invalid-feedback">
                                                        Masukkan Jumblah Porsi
                                                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <button class="<?php echo (!empty($row['id_bayar'])) ? "btn btn-secondary btn-sm me-1 disabled" : "btn btn-warning btn-sm me-1" ; ?> " data-bs-toggle="modal" data-bs-target="#ModalDelete<?php echo $row['id_list_order'] ?>"><i class="bi bi-trash"></i></button>
                                        </div>
                                    </td>
                                </tr>
                            <?php
