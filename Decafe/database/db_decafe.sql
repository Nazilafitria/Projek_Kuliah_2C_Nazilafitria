...
CREATE DATABASE IF NOT EXISTS `db_decafe` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE  */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `db_decafe`;
...
CREATE TABLE IF NOT EXISTS `tb_daftar_menu` (
  ...
  `foto` varchar(200) CHARACTER SET utf8mb4 COLLATE  DEFAULT NULL,
  `nama_menu` varchar(200) CHARACTER SET utf8mb4 COLLATE  DEFAULT NULL,
  `keterangan` varchar(200) CHARACTER SET utf8mb4 COLLATE  DEFAULT NULL,
  `kategori` int DEFAULT NULL,
  `harga` varchar(100) CHARACTER SET utf8mb4 COLLATE  DEFAULT NULL,
  `stok` varchar(50) CHARACTER SET utf8mb4 COLLATE  DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_user` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nama` varchar(200) CHARACTER SET utf8mb4 COLLATE  DEFAULT NULL,
